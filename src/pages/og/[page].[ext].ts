...
const STATIC_PAGES: Record<string, OgImageProps> = {
	press: {
		title: "Press",
		description:
			"Announcements, publications, stories, and awards from across the Quori community.",
	},
	home: {
	...
	contributors: {
		title: "Contributors",
		description: "People and organizations advancing human-centered robotics and AI together",
	},
	"get-involved": {
		title: "Get Involved",
		description:
