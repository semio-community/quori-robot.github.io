...
export default function HeroSection({
	...
	const titleNode = (
		<>
			<span className="text-accent-three font-semibold uppercase tracking-wide">Community</span>{" "}
			<span className="text-accent-one font-semibold uppercase tracking-wide">Research</span>{" "}
			<span className="text-accent-two font-semibold uppercase tracking-wide">Platform</span>
		</>
	);
	...
	return (
		<HeroHeader
			...
			description={
				<>
					A low-cost, <span className="font-medium text-foreground">community-informed</span>,
					modular, open-source <br className="hidden md:flex" />
					<span className="font-medium text-foreground">social robot</span> platform for the{" "}
