...
import { Earth, EmojiFunnySquare, HandShake, Rocket2 } from "@solar-icons/react-perf/LineDuotone";
...
export default function ValuesSection({
	...
	primaryCopy = (
		<>
			We welcome curious builders and researchers, celebrate bold ideas, and design with
			accessibility and representation in mind.
		</>
	),
	features = [
		{
			...
			icon: <EmojiFunnySquare className="w-10 h-10 dark:text-black text-white" />,
		},
		{
