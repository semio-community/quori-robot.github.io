...
import { Book2, Global, HandStars, SquareAcademicCap } from "@solar-icons/react-perf/LineDuotone";
...
export default function StrategySection({
	...
	primaryCopy = (
		<>
			We align the community around a common platform and shared rituals—resources, events, and
			collaboration channels—so improvements spread quickly and newcomers are never alone.
		</>
	),
	features = [
		{
		...
		},
		{
			...
			icon: <SquareAcademicCap className="w-12 h-12 mx-auto mb-3 text-accent-one" />,
		},
		{
