...
import { BaseUrlProvider, CallToActionButton } from "@semio-community/ecosystem-site-core";
		...
		<BaseUrlProvider baseUrl={BASE_URL}>
			<div className="space-y-12">
				...
				<div className="bg-linear-to-bl from-accent-three/10 to-accent-base/10 rounded-lg p-8 border border-accent-three/20 backdrop-blur-lg text-center text-lg flex flex-col gap-6">
					<div>
						Quori is a not-for-profit, low-cost, modular, open-source social robot platform designed{" "}
						<span className="italic">with</span> the HRI community{" "}
						<span className="italic">for</span> the HRI community.
					</div>
