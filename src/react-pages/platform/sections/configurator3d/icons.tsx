...
export function HeadIcon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
			width="100%"
			height="100%"
			...
			{...props}
		>
			<g transform="matrix(1.202934,0.278199,-0.257259,1.112386,0.898882,-4.860649)">
				<path
			...
			<g transform="matrix(0.818182,0,0,1.052632,3.272727,-1.157895)">
				<path
			...
			/>
			<g transform="matrix(0.881117,0,0,0.855012,1.141186,1.862209)">
				<path
...
export function TorsoIcon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
			width="100%"
			height="100%"
			...
			{...props}
		>
			<g transform="matrix(1,0,0,1,-3.75,0)">
				<path
...
export function BaseIcon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
			width="100%"
			height="100%"
			...
			{...props}
		>
			<g transform="matrix(0.922704,0,0,0.922704,1.047909,0.850636)">
				<path
			...
			<g transform="matrix(1,0,0,1,0,-13.859909)">
				<path
...
export function ChestIcon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
			...
			{...props}
		>
			<g transform="matrix(1.263648,0,0,1.263648,-3.279157,-3.317306)">
				<path
			...
			<g transform="matrix(1.263648,0,0,1.263648,-5.732733,-6.885591)">
				<path
					d="M18.392,10.865C18.69,10.716 19.364,10.283 19.423,10.616C19.535,11.243 19.631,13.492 19.364,14C18.886,14.454 18.93,14.374 18.93,14.374"
					style={{
						fill: "none",
...
export function ArmsIcon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
			width="100%"
			height="100%"
			...
			{...props}
		>
			<g transform="matrix(1,0,0,1,0,-0.785357)">
				<path
...
export function StandIcon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
			width="100%"
			height="100%"
