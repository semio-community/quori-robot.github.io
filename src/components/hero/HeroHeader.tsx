			...
			{img ? (
				<div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
					<img
						src={img}
						alt={imgAlt || ""}
						className={clsx("h-full w-full object-cover object-center", imgClassName)}
...
function buildGlyphs(count: number, scaling: number): Glyph[] {
	...
	return Array.from({ length: count }, (_, idx) => {
		// biome-ignore lint/style/noNonNullAssertion: variants array is non-empty and index is bounded by modulo
