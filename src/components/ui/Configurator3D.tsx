...
import { type Configurator3DProps, DEFAULT_OFFSCREEN_POSITION } from "./configurator3d/types";
		...
		>
			<div className="flex flex-col gap-4 sm:flex-row sm:items-stretch">
				...
				<div className="order-1 sm:order-2 w-full sm:flex-1 min-w-0">
					<div className="w-full h-138.75 overflow-hidden">
