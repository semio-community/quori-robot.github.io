...
import { FeaturedStar, type FeaturedState } from "@semio-community/ecosystem-site-core";
import { Avatar, type AvatarType } from "@semio-community/ecosystem-site-core";
...
export const DetailHero: React.FC<DetailHeroProps> = ({
  ...
  return (
    <div
      className={`relative mb-8 -mx-4 md:-mx-8 rounded-none lg:rounded-xl overflow-hidden ${className}`}
    >
